...
scriptList=("${startFile}" "${stopFile}" "${stopKillFile}" "${setupFile}" "${newMachineFile}" "${orbStackFile}")
scriptInfo=("${startInfo}" "${stopInfo}" "${stopKillInfo}" "${setupInfo}" "${newMachineInfo}" "${orbStackInfo}")
